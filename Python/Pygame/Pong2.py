    ...
    while not done:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                # When escape is pressed exit to Main Menu
                if event.type == pygame.K_ESCAPE:
                    done = True
                # Player can use W and S, and arrow keys
                ...
                if event.type == pygame.K_UP or event.type == pygame.K_w or event.type == pygame.K_DOWN or event.type == pygame.K_s:
                    p1Speed = 0
            print(p1score)
